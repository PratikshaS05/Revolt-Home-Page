...
const GridDistributor = require("../models/gridDistributorModel.js");
...
exports.signup = async (req, res, next) => {
  try {
    const newUser = await GridDistributor.create({
...
exports.login = async (req, res, next) => {
  ...
  const user = await GridDistributor.findOne({ email });
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  const freshUser = await GridDistributor.findById(decoded.id);
...
exports.forgetPassword = async (req, res, next) => {
  ...
  const user = await GridDistributor.findOne({ email: req.body.email });
...
exports.resetPassword = async (req, res, next) => {
  ...
  const user = await GridDistributor.findOne({
...
exports.updatePassword = async (req, res, next) => {
  ...
  const user = await GridDistributor.findById(req.user.id).select("+password");
